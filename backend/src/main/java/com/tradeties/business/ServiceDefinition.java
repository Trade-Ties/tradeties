 ...
 *
 * @param tradeId                  {@code null} for work that spans trades. Otherwise a trade
 *                                 the business actually holds — checked by the service and
 *                                 guaranteed by a composite foreign key
